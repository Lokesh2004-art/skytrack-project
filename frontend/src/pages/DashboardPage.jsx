...
import TopFlightsWidget from '../components/TopFlightsWidget'
import LiveActivityWidget from '../components/LiveActivityWidget'
import TrafficByRegionWidget from '../components/TrafficByRegionWidget'
...
export default function DashboardPage() {
  ...
  return (
    <AppFrame flights={flights} onSelectFlight={setSelectedFlightId}>
      <StatCards flights={flights} />

      <div className="relative min-h-[520px] overflow-hidden rounded-2xl border border-stroke bg-panel">
        <FlightMap
          flights={mapFlights}
      ...
      <section className="grid grid-cols-1 gap-4 xl:grid-cols-3">
        <TopFlightsWidget flights={filteredFlights} onSelectFlight={setSelectedFlightId} />
        <LiveActivityWidget flights={filteredFlights} onSelectFlight={setSelectedFlightId} />
        <TrafficByRegionWidget flights={filteredFlights} />
      </section>
    </AppFrame>
  )
}
